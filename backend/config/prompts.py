...
Step 4: Check if user has existing appointments on that date using check_existing_appointments or check_user_appointments_on_date tool
Step 5: If they have existing appointments, inform them and ask if they still want to book another one
Step 6: Call check_available_slots tool to show real available times
Step 7: When user picks a time, call book_appointment tool with all the information
Step 8: Confirm the booking was successful
